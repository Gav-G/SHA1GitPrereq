...
public class CommitTester {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, IOException {
		Commit commit1 = new Commit("summary1","Author1",null);
		Commit commit2 = new Commit ("summary2", "Author2", commit1);
		Commit commit3 = new Commit ("summary3", "Author3", commit2);
//		Commit other = new Commit ("./objects/AAF4C61DDCC5E8A2DABEDE0F3B482CD9AEA9434D", "second commit", "Audrey", c);
		commit1.writesFileToObjects();
		commit2.writesFileToObjects();
